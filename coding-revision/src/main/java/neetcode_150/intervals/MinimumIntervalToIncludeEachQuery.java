package neetcode_150.intervals;
...
public class MinimumIntervalToIncludeEachQuery {
    ...
    public static void minInterval() {
        /*
         * Interview Template:
         *
         * 1. Clarify Requirements:
        ...
        System.out.println("=== MinimumIntervalToIncludeEachQuery test cases ===");
        int[] case1 = new int[]{1, 2, 3, 4};
        System.out.println("Case 1: case 1");
        System.out.println("Input: " + java.util.Arrays.toString(case1));
        MinimumIntervalToIncludeEachQuery.minInterval();
        int[] case2 = new int[]{-1, 0, 1, 2};
        System.out.println("Case 2: case 2");
        System.out.println("Input: " + java.util.Arrays.toString(case2));
        MinimumIntervalToIncludeEachQuery.minInterval();
        System.out.println("All MinimumIntervalToIncludeEachQuery scenarios reviewed.");
    }
}
