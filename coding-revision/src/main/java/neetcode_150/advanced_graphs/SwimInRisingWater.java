package neetcode_150.advanced_graphs;
...
public class SwimInRisingWater {
    ...
    public static void swimInWater() {
        /*
         * Interview Template:
         *
         * 1. Clarify Requirements:
